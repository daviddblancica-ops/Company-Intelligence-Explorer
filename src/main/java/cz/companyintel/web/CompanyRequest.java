...
public class CompanyRequest {
    ...
    @Valid
    @Size(max = 100, message = "Firma může obsahovat nejvýše 100 osob")
    private List<@NotNull(message = "Záznam osoby nesmí být prázdný") PersonRole> people;
    ...
    public static class PersonRole {
        ...
        @NotBlank(message = "Role osoby je povinná")
